...
//ȡ��ģ���ã�����ʽ������8������8������ȡģ
		...
		{ 0x00, 0x00, 0x0F, 0x04, 0x04, 0x04, 0x04, 0xFF, 0x04, 0x04, 0x04,
				0x04, 0x0F, 0x00, 0x00, 0x00 },/*"��",0*/

		{ 0x40, 0x40, 0x40, 0x5F, 0x55, 0x55, 0x55, 0x75, 0x55, 0x55, 0x55,
				0x5F, 0x40, 0x40, 0x40, 0x00 },
		{ 0x00, 0x40, 0x20, 0x0F, 0x09, 0x49, 0x89, 0x79, 0x09, 0x09, 0x09,
				0x0F, 0x20, 0x40, 0x00, 0x00 },/*"��",1*/

		{ 0x00, 0xFE, 0x02, 0x42, 0x4A, 0xCA, 0x4A, 0x4A, 0xCA, 0x4A, 0x4A,
				0x42, 0x02, 0xFE, 0x00, 0x00 },
		{ 0x00, 0xFF, 0x40, 0x50, 0x4C, 0x43, 0x40, 0x40, 0x4F, 0x50, 0x50,
				0x5C, 0x40, 0xFF, 0x00, 0x00 },/*"԰",2*/

		{ 0x00, 0x00, 0xF8, 0x88, 0x88, 0x88, 0x88, 0xFF, 0x88, 0x88, 0x88,
				0x88, 0xF8, 0x00, 0x00, 0x00 },
		{ 0x00, 0x00, 0x1F, 0x08, 0x08, 0x08, 0x08, 0x7F, 0x88, 0x88, 0x88,
				0x88, 0x9F, 0x80, 0xF0, 0x00 },/*"��",3*/

		{ 0x80, 0x82, 0x82, 0x82, 0x82, 0x82, 0x82, 0xE2, 0xA2, 0x92, 0x8A,
				0x86, 0x82, 0x80, 0x80, 0x00 },
		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x80, 0x7F, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00 },/*"��",4*/

		{ 0x24, 0x24, 0xA4, 0xFE, 0xA3, 0x22, 0x00, 0x22, 0xCC, 0x00, 0x00,
				0xFF, 0x00, 0x00, 0x00, 0x00 },
		{ 0x08, 0x06, 0x01, 0xFF, 0x00, 0x01, 0x04, 0x04, 0x04, 0x04, 0x04,
				0xFF, 0x02, 0x02, 0x02, 0x00 },/*"��",5*/

		{ 0x10, 0x10, 0x10, 0xFF, 0x10, 0x90, 0x08, 0x88, 0x88, 0x88, 0xFF,
				0x88, 0x88, 0x88, 0x08, 0x00 },
		{ 0x04, 0x44, 0x82, 0x7F, 0x01, 0x80, 0x80, 0x40, 0x43, 0x2C, 0x10,
				0x28, 0x46, 0x81, 0x80, 0x00 },/*"��",6*/

		{ 0x10, 0x10, 0xD0, 0xFF, 0x90, 0x10, 0x00, 0xFE, 0x02, 0x02, 0x02,
				0xFE, 0x00, 0x00, 0x00, 0x00 },
		{ 0x84, 0x83, 0x80, 0xFF, 0x80, 0x83, 0xE0, 0x9F, 0x80, 0x80, 0x80,
				0xBF, 0xC0, 0xC0, 0xF8, 0x80 },/*"��",7*/

		{ 0x80, 0x80, 0x9E, 0x92, 0x92, 0x92, 0x9E, 0xE0, 0x80, 0x9E, 0xB2,
				0xD2, 0x92, 0x9E, 0x80, 0x00 },
		{ 0x88, 0x88, 0xF4, 0x94, 0x92, 0x92, 0xF1, 0x80, 0x81, 0xF2, 0x92,
				0x94, 0x94, 0xF8, 0x88, 0x80 },/*"��",8*/

		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x3F, 0xC0, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00 },
		{ 0x80, 0xC0, 0xA0, 0x90, 0x8C, 0x83, 0x80, 0x80, 0x80, 0x83, 0x8C,
				0x90, 0xA0, 0xC0, 0x80, 0x80 },/*"��",9*/

		{ 0x00, 0x08, 0x48, 0x88, 0x08, 0xC8, 0x38, 0x00, 0x90, 0x10, 0x10,
				0xFF, 0x10, 0x10, 0x10, 0x00 },
		{ 0x00, 0x20, 0x10, 0x0C, 0x03, 0x04, 0x18, 0x00, 0x00, 0x43, 0x80,
				0x7F, 0x00, 0x00, 0x00, 0x00 },/*"��",10*/

		{ 0x00, 0x00, 0x00, 0xFF, 0x08, 0x08, 0x08, 0x40, 0x40, 0x40, 0xFF,
				0x20, 0x22, 0xAC, 0x20, 0x00 },
		{ 0x00, 0x7F, 0x21, 0x21, 0x21, 0x21, 0x7F, 0x80, 0x40, 0x20, 0x17,
				0x18, 0x26, 0x41, 0xF0, 0x00 },/*"ս",11*/

		{ 0x04, 0x84, 0x84, 0xFC, 0x84, 0x84, 0x40, 0x44, 0xC4, 0x44, 0x44,
				0xC4, 0x44, 0x44, 0x40, 0x00 },
		{ 0xA0, 0xE0, 0xA0, 0x9F, 0x90, 0x90, 0xC0, 0xB0, 0x8F, 0x80, 0x80,
				0xBF, 0xC0, 0xC0, 0xF0, 0x80 },/*"��",12*/

		{ 0x10, 0x2C, 0x24, 0x24, 0xA4, 0xA4, 0x65, 0xA6, 0x24, 0x24, 0x24,
				0x24, 0xA4, 0x34, 0x0C, 0x00 },
		{ 0xC0, 0xC9, 0xC9, 0xA9, 0xA4, 0x94, 0xD2, 0x89, 0xFF, 0x84, 0x8A,
				0x91, 0x90, 0xA0, 0xA0, 0x80 },/*"��",13*/

		{ 0x20, 0x20, 0x24, 0x24, 0xA4, 0x7F, 0x24, 0x24, 0x24, 0x7F, 0xA4,
				0x24, 0x24, 0x20, 0x20, 0x00 },
		{ 0x04, 0x04, 0x22, 0x19, 0x40, 0x80, 0x7F, 0x00, 0x08, 0x30, 0x04,
				0x09, 0x32, 0x04, 0x04, 0x00 },/*"��",14*/

		{ 0x00, 0x02, 0xEA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAF, 0xAA, 0xAA, 0xAA,
				0xAA, 0xEA, 0x02, 0x00, 0x00 },
		{ 0x02, 0x02, 0xFA, 0x4A, 0x4B, 0x4A, 0x4A, 0x4A, 0x4A, 0x4A, 0x4B,
				0x4A, 0xFA, 0x02, 0x02, 0x00 },/*"ϲ",15*/

		{ 0x10, 0x10, 0xD0, 0xFF, 0x90, 0x10, 0x00, 0xFE, 0x02, 0x02, 0x02,
				0xFE, 0x00, 0x00, 0x00, 0x00 },
		{ 0x04, 0x03, 0x00, 0xFF, 0x00, 0x83, 0x60, 0x1F, 0x00, 0x00, 0x00,
				0x3F, 0x40, 0x40, 0x78, 0x00 },/*"��",16*/

		{ 0x80, 0x80, 0x9E, 0x92, 0x92, 0x92, 0x9E, 0xE0, 0x80, 0x9E, 0xB2,
				0xD2, 0x92, 0x9E, 0x80, 0x00 },
		{ 0x08, 0x08, 0xF4, 0x94, 0x92, 0x92, 0xF1, 0x00, 0x01, 0xF2, 0x92,
				0x94, 0x94, 0xF8, 0x08, 0x00 },/*"��",17*/

		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x3F, 0xC0, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00 },
		{ 0x80, 0x40, 0x20, 0x10, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x03, 0x0C,
				0x10, 0x20, 0x40, 0x80, 0x00 },/*"��",18*/

		{ 0x04, 0x14, 0xA4, 0x44, 0xAF, 0x14, 0x04, 0x04, 0x04, 0xF4, 0x0F,
				0x24, 0x44, 0x04, 0x04, 0x00 },
		{ 0x12, 0x49, 0x84, 0x42, 0x3F, 0x81, 0x41, 0x31, 0x0D, 0x03, 0x0D,
				0x31, 0x41, 0x81, 0x81, 0x00 },/*"��",19*/

		{ 0x00, 0xFE, 0x22, 0x22, 0xFE, 0x00, 0x40, 0x3C, 0x10, 0x10, 0xFF,
				0x10, 0x10, 0x10, 0x00, 0x00 },
		{ 0x80, 0x7F, 0x02, 0x82, 0xFF, 0x00, 0x40, 0x42, 0x42, 0x42, 0x7F,
				0x42, 0x42, 0x42, 0x40, 0x00 },/*"ʤ",20*/

		{ 0x20, 0x20, 0x24, 0x24, 0xA4, 0x7F, 0x24, 0x24, 0x24, 0x7F, 0xA4,
				0x24, 0x24, 0x20, 0x20, 0x00 },
		{ 0x04, 0x04, 0x22, 0x19, 0x40, 0x80, 0x7F, 0x00, 0x08, 0x30, 0x04,
				0x09, 0x32, 0x04, 0x04, 0x00 },/*"��",21*/

		{ 0x00, 0x02, 0xEA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAF, 0xAA, 0xAA, 0xAA,
				0xAA, 0xEA, 0x02, 0x00, 0x00 },
		{ 0x02, 0x02, 0xFA, 0x4A, 0x4B, 0x4A, 0x4A, 0x4A, 0x4A, 0x4A, 0x4B,
				0x4A, 0xFA, 0x02, 0x02, 0x00 },/*"ϲ",22*/

		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x3F, 0xC0, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00 },
		{ 0x80, 0x40, 0x20, 0x10, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x03, 0x0C,
				0x10, 0x20, 0x40, 0x80, 0x00 },/*"��",23*/

		{ 0x00, 0x10, 0x10, 0x92, 0x54, 0x30, 0x10, 0xFF, 0x10, 0x30, 0x54,
				0x92, 0x10, 0x10, 0x00, 0x00 },
		{ 0x84, 0x85, 0x45, 0x44, 0x24, 0x14, 0x0C, 0x06, 0x0C, 0x14, 0x24,
				0x44, 0x45, 0x84, 0x84, 0x00 },/*"��",24*/

		{ 0x04, 0x14, 0xA4, 0x44, 0xAF, 0x14, 0x04, 0x04, 0x04, 0xF4, 0x0F,
				0x24, 0x44, 0x04, 0x04, 0x00 },
		{ 0x12, 0x49, 0x84, 0x42, 0x3F, 0x81, 0x41, 0x31, 0x0D, 0x03, 0x0D,
				0x31, 0x41, 0x81, 0x81, 0x00 },/*"��",25*/

		{ 0x00, 0xFE, 0x22, 0x22, 0xFE, 0x00, 0x40, 0x3C, 0x10, 0x10, 0xFF,
				0x10, 0x10, 0x10, 0x00, 0x00 },
		{ 0x80, 0x7F, 0x02, 0x82, 0xFF, 0x00, 0x40, 0x42, 0x42, 0x42, 0x7F,
				0x42, 0x42, 0x42, 0x40, 0x00 }, /*"ʤ",26*/
