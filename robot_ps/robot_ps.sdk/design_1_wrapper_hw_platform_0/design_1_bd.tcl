...
proc create_root_design { parentCell } {
  ...
  set ov5640_rst_n [ create_bd_port -dir O ov5640_rst_n ]
  set pump [ create_bd_port -dir O pump ]
  set pwm_s1 [ create_bd_port -dir O pwm_s1 ]
  set pwm_s2 [ create_bd_port -dir O pwm_s2 ]
  set pwm_s3 [ create_bd_port -dir O pwm_s3 ]
  set res [ create_bd_port -dir O res ]
  set sio_c [ create_bd_port -dir O sio_c ]
  set sio_d [ create_bd_port -dir O sio_d ]
  set uart_tx [ create_bd_port -dir O uart_tx ]

  # Create instance: OLED_IP_0, and set properties
  set OLED_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:OLED_IP:1.0 OLED_IP_0 ]

  # Create instance: Robotarm_car_0, and set properties
  set Robotarm_car_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Robotarm_car:1.0 Robotarm_car_0 ]
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {97.082} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {500.000} CONFIG.MMCM_CLKOUT0_DIVIDE_F {2.000} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz_0

  # Create instance: ov5640_dvp_bram_0, and set properties
  set ov5640_dvp_bram_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ov5640_dvp_bram:1.0 ov5640_dvp_bram_0 ]

  # Create instance: ov5640_sccb_0, and set properties
  set ov5640_sccb_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ov5640_sccb:1.0 ov5640_sccb_0 ]
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  # Create instance: tts_0, and set properties
  set tts_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:tts:1.0 tts_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins ov5640_sccb_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins OLED_IP_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins ov5640_dvp_bram_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins Robotarm_car_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI] [get_bd_intf_pins tts_0/S00_AXI]

  # Create port connections
  connect_bd_net -net OLED_IP_0_CS [get_bd_ports CS] [get_bd_pins OLED_IP_0/CS]
  connect_bd_net -net OLED_IP_0_DC [get_bd_ports DC] [get_bd_pins OLED_IP_0/DC]
  connect_bd_net -net OLED_IP_0_SCL [get_bd_ports SCL] [get_bd_pins OLED_IP_0/SCL]
  connect_bd_net -net OLED_IP_0_SDA [get_bd_ports SDA] [get_bd_pins OLED_IP_0/SDA]
  connect_bd_net -net OLED_IP_0_res [get_bd_ports res] [get_bd_pins OLED_IP_0/res]
  connect_bd_net -net Robotarm_car_0_pump [get_bd_ports pump] [get_bd_pins Robotarm_car_0/pump]
  connect_bd_net -net Robotarm_car_0_pwm_s1 [get_bd_ports pwm_s1] [get_bd_pins Robotarm_car_0/pwm_s1]
  connect_bd_net -net Robotarm_car_0_pwm_s2 [get_bd_ports pwm_s2] [get_bd_pins Robotarm_car_0/pwm_s2]
  connect_bd_net -net Robotarm_car_0_pwm_s3 [get_bd_ports pwm_s3] [get_bd_pins Robotarm_car_0/pwm_s3]
  connect_bd_net -net button_1 [get_bd_ports button] [get_bd_pins ov5640_dvp_bram_0/button]
  connect_bd_net -net cam_data_1 [get_bd_ports cam_data] [get_bd_pins ov5640_dvp_bram_0/cam_data]
  connect_bd_net -net cam_href_1 [get_bd_ports cam_href] [get_bd_pins ov5640_dvp_bram_0/cam_href]
  connect_bd_net -net cam_pclk_1 [get_bd_ports cam_pclk] [get_bd_pins ov5640_dvp_bram_0/cam_pclk]
  connect_bd_net -net cam_vsync_1 [get_bd_ports cam_vsync] [get_bd_pins ov5640_dvp_bram_0/cam_vsync]
  connect_bd_net -net clk_in1_1 [get_bd_ports clk_in1] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net ov5640_dvp_bram_0_addrb [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins ov5640_dvp_bram_0/addrb]
  connect_bd_net -net ov5640_dvp_bram_0_dinb [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins ov5640_dvp_bram_0/dinb]
  connect_bd_net -net ov5640_dvp_bram_0_enb [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins ov5640_dvp_bram_0/enb]
  connect_bd_net -net ov5640_dvp_bram_0_rstb [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins ov5640_dvp_bram_0/rstb]
  connect_bd_net -net ov5640_dvp_bram_0_web [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins ov5640_dvp_bram_0/web]
  connect_bd_net -net ov5640_sccb_0_ov5640_pwdn [get_bd_ports ov5640_pwdn] [get_bd_pins ov5640_sccb_0/ov5640_pwdn]
  connect_bd_net -net ov5640_sccb_0_ov5640_rst_n [get_bd_ports ov5640_rst_n] [get_bd_pins ov5640_sccb_0/ov5640_rst_n]
  connect_bd_net -net ov5640_sccb_0_sccb_cfg_done [get_bd_pins ov5640_dvp_bram_0/capture_en] [get_bd_pins ov5640_sccb_0/sccb_cfg_done]
  connect_bd_net -net ov5640_sccb_0_sio_c [get_bd_ports sio_c] [get_bd_pins ov5640_sccb_0/sio_c]
  connect_bd_net -net ov5640_sccb_0_sio_d [get_bd_ports sio_d] [get_bd_pins ov5640_sccb_0/sio_d]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins OLED_IP_0/s00_axi_aclk] [get_bd_pins Robotarm_car_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins ov5640_dvp_bram_0/s00_axi_aclk] [get_bd_pins ov5640_sccb_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins tts_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins OLED_IP_0/s00_axi_aresetn] [get_bd_pins Robotarm_car_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins ov5640_dvp_bram_0/s00_axi_aresetn] [get_bd_pins ov5640_sccb_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins tts_0/s00_axi_aresetn]
  connect_bd_net -net tts_0_uart_tx [get_bd_ports uart_tx] [get_bd_pins tts_0/uart_tx]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs OLED_IP_0/S00_AXI/S00_AXI_reg] SEG_OLED_IP_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Robotarm_car_0/S00_AXI/S00_AXI_reg] SEG_Robotarm_car_0_S00_AXI_reg
  create_bd_addr_seg -range 0x80000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ov5640_dvp_bram_0/S00_AXI/S00_AXI_reg] SEG_ov5640_dvp_bram_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ov5640_sccb_0/S00_AXI/S00_AXI_reg] SEG_ov5640_sccb_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs tts_0/S00_AXI/S00_AXI_reg] SEG_tts_0_S00_AXI_reg
