...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ov5640_dvp_bram
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ov5640_dvp_bram_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ov5640_sccb
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ov5640_sccb_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = OLED_IP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = OLED_IP_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = Robotarm_car
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Robotarm_car_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tts
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = tts_0
END
